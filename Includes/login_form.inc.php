...
<p><?php if (array_key_exists('login', $login_errors)) {
	...
	}?><label for="email"><strong>User Name</strong></label><br /><?php create_form_input('username', 'text', $login_errors); ?><br /><label for="pass"><strong>Password</strong></label><br /><?php create_form_input('pass', 'password', $login_errors); ?> <a href="forgot_password.php" align="right">Forgot?</a><br /><input type="submit" value="Login &rarr;"></p>
</form>