...
// This is the function that sql out the session head list.
...
$page_title = 'Check Session Chair List';
...
$query = "SELECT * FROM users WHERE utype = '1'"; //specify what type of user you want to retreive,0-user,1-sh,2-bm,
...
$i=0;
	echo " 
	<b><center>Session Head List</center></b><br><br>
	<table>
		<tr>
